...
forfiles /p c:\progra~1\rockwe~1\factor~1\pipc\interfaces\ /m ftld* /d -%1% /c "cmd /c echo @file">>%LogFile%
forfiles /p c:\progra~2\rockwe~1\factor~2\pipc\interfaces\ /m ftld* /d -%1% /c "cmd /c echo @file">>%LogFile%
...
echo.Deleting:>>%LogFile%
forfiles /p c:\progra~1\rockwe~1\factor~1\pipc\dat\ /m pibufq_* /d -%1% /c "cmd /c echo @file">>%LogFile%
forfiles /p c:\progra~2\rockwe~1\factor~2\pipc\dat\ /m pibufq_* /d -%1% /c "cmd /c echo @file">>%LogFile%
...
forfiles /p c:\progra~1\rockwe~1\factor~1\pipc\dat\ /m pibufq_* /c "cmd /c echo @file">>%LogFile%
forfiles /p c:\progra~1\rockwe~1\factor~1\pipc\dat\ /m pibufq_* /c "cmd /c echo @file">>%LogFile%
