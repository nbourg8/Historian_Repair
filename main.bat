...
psexec \\192.168.1.13 -c resources\FTLD_Stop_and_Delete.bat %daysback%
...
psexec \\192.168.1.20 -c resources\FTLD_Stop_and_Delete.bat %daysback%
copy x:\HISTREP.txt %~dp0
copy /b %LogFile%+HISTREP.txt %LogFile%
del x:\HISTREP.txt
net use x: /delete /y
...
psexec \\192.168.1.14 -c resources\Buffer_Repair.bat %daysback%
copy x:\HISTREP.txt %~dp0
copy /b %LogFile%+HISTREP.txt %LogFile%
del x:\HISTREP.txt
net use x: /delete /y
...
net use x: \\192.168.1.13\C$
psexec \\192.168.1.13 -c resources\FTLD_Start.bat
copy x:\HISTREP.txt %~dp0
copy /b %LogFile%+HISTREP.txt %LogFile%
del x:\HISTREP.txt
net use x: /delete /y
...
net use x: \\192.168.1.20\C$
psexec \\192.168.1.20 -c resources\FTLD_Start.bat
copy x:\HISTREP.txt %~dp0
copy /b %LogFile%+HISTREP.txt %LogFile%
del x:\HISTREP.txt
net use x: /delete /y
